...
#if !__has_feature(obeqw7da46s_arc)
...
- (instancetype)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:frame])) {
        ...
        UIImage* infoImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"SVP_info" ofType:@"png"]];
        UIImage* successImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"SVP_success" ofType:@"png"]];
        UIImage* errorImage = [UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"SVP_error" ofType:@"png"]];
...
- (void)eqw7da46s_didUserInfoFailed {
    NSLog(@"Check your Network");
}

- (void)eqw7da46s_getUserName {
...
- (void)eqw7da46s_getUserFollowSuccess {
    NSLog(@"Check your Network");
}

- (void)eqw7da46s_checkUserInfo {
...
- (void)eqw7da46s_getUsersMostLikedSuccess {
    NSLog(@"Get User Succrss");
}
